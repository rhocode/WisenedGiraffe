      ...
      db.select()
          ...
          .then((rows) => {
            if (rows.length == 1) {
              ...
              reject('No element found or too many matching rows: ' + table +
...
const getTableEntries = (table, db) => {
  ...
  return new Promise((resolve) => {
    db.select().from(tableRef).exec().then((rows) => { resolve(rows); });
  });
};
...
const generateSpringList = async db => {
  const ret = [];
  const types = [
    'Coal Ore', 'Iron Ore', 'Limestone Ore', 'Copper Ore', 'Caterium Ore',
    'Crude Oil', 'Raw Quartz', 'Sulfur', 'Bauxite', 'S.A.M. Ore', 'Silica',
    'Uranium'
  ];
  const machine_type_miner =
      await getTableEntryIdByName('machine_class', 'Miner')(db);
  const machine_type_container =
      await getTableEntryIdByName('machine_class', 'Container')(db);
  const spring_type_miner =
      await getTableEntryIdByName('spring_type', 'Miner')(db);
  const spring_type_container =
      await getTableEntryIdByName('spring_type', 'Container')(db);

  const machine_node_type_oilpump =
      await getTableEntryIdByName('machine_class', 'Oil Pump')(db);
...
const data = [
  {
    key : 'purity_type',
    value : [
      {name : 'Impure', quantity : 30}, {name : 'Normal', quantity : 60},
  ...
  },
  {
    ...
    value : [
      ...
      },
      {
        ...
        speed : 9999999,
        machine_version_id :
            getTableEntryIdByName('machine_version', 'internal'),
        rank : -1
      },
    ]
  },
  ...
  },
  {
    ...
    value : [
      ...
      },
      {
        ...
        machine_version_id : getTableEntryIdByName('machine_version', 'Mk.1'),
        machine_class_id :
            getTableEntryIdByName('machine_class', 'Constructor'),
        icon : baseUrl + 'Constructor.png',
        speed : 100,
        power : 4,
        input_slots : 1,
      ...
      },
      {
        ...
        machine_version_id : getTableEntryIdByName('machine_version', 'Mk.1'),
        machine_class_id :
            getTableEntryIdByName('machine_class', 'Manufacturer'),
        icon : baseUrl + 'Manufacturer.png',
        speed : 100,
        power : 55,
        hidden : true,
  ...
  {key : 'spring', value : generateSpringList}, {
    ...
    value : [
      ...
      },
      {
        ...
        hidden : true,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Caterium Wire')
      },
      {
        name : 'Cable',
        inputs : parseRecipeIngredients([
      ...
      },
      {
        ...
        hidden : true,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Screw (Alt.)')
      },
      {
        name : 'Concrete',
        inputs : parseRecipeIngredients([ {
      ...
      },
      {
        ...
        quantity : 3,
        hidden : true,
        player_unlock_id : getTableEntryIdByName('player_unlock',
      ...
      },
      {
        ...
        hidden : true,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Stitched Iron Plate')
      },
      {
        name : 'Rotor',
        inputs : parseRecipeIngredients([
      ...
      },
      {
        ...
        hidden : true,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Rotor (Alt.)')
      },
      {
        name : 'Modular Frame',
        inputs : parseRecipeIngredients([
      ...
      },
      {
        ...
        hidden : true,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Modular Frame (Alt.)')
      },
      {
        name : 'Encased Industrial Beam',
        inputs : parseRecipeIngredients([
      ...
      },
      {
        ...
        player_unlock_id : getTableEntryIdByName(
            'player_unlock', 'Encased Industrial Beam (Alt.)')
      },
      {
        name : 'Heavy Modular Frame',
        inputs : parseRecipeIngredients([
      ...
      },
      {
        ...
        hidden : true,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Heavy Modular Frame (Alt.)')
      },
      {
        name : 'Iron Ingot (Alt.)',
        inputs : parseRecipeIngredients([
        ...
        hidden : true,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Iron Ingot (Alt.)')
      },
      {
        name : 'Steel Ingot',
        inputs : parseRecipeIngredients([
      ...
      },
      {
        ...
        hidden : true,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Steel Ingot (Alt.)')
      },
      {
        name : 'Steel Beam',
        inputs : parseRecipeIngredients([
      ...
      },
      {
        ...
        hidden : true,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Quickwire (Alt.)')
      },
      {
        name : 'Motor',
        inputs : parseRecipeIngredients([
      ...
      },
      {
        ...
        quantity : 3,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Circuit Board (Alt.)'),
      },
      {
        name : 'Caterium Circuit Board',
        inputs : parseRecipeIngredients([
        ...
        quantity : 3,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Caterium Circuit Board'),
      },
      {
        name : 'Rubber Cable',
        inputs : parseRecipeIngredients([
        ...
        quantity : 10,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Rubber Cable'),
      },
      {
        name : 'Computer',
        inputs : parseRecipeIngredients([
      ...
      },
      {
        ...
        quantity : 3,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Caterium Computer')
      },
      {
        name : 'Supercomputer',
        inputs : parseRecipeIngredients([
      ...
      },
      {
        ...
        quantity : 3,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Stator (Alt.)'),
      },
      {
        name : 'Battery',
        inputs : parseRecipeIngredients([
      ...
      },
      {
        ...
        quantity : 3,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Compacted Coal (Alt.)'),
      },
      {
        name : 'Silica (Alt.)',
        inputs : parseRecipeIngredients([
        ...
        quantity : 9,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Silica (Alt.)'),
      },
      {
        name : 'Quartz Crystal',
        inputs : parseRecipeIngredients([
      ...
      },
      {
        ...
        quantity : 1,
        player_unlock_id :
            getTableEntryIdByName('player_unlock', 'Crystal Oscillator (Alt.)'),
      },
      {
...
const firebaseData = {};
data.forEach(elem => { firebaseData[elem.key] = elem.value; });
